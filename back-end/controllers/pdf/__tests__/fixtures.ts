/**
 * Jeux de données de test spécifiques au PdfController.
 *
 * Ces objets simulent les lignes renvoyées par les repositories.
 * Si le schéma Drizzle évolue, il faut mettre à jour ces fixtures.
 */
