 ...
 *
 * Le contrôleur utilise l'injection de dépendances : chaque repo et service
 * est passé en paramètre du constructeur. Les tests injectent directement
 * les mocks créés via les factory functions du dossier mocks/.
 *
 * Résultat : aucun vi.mock(), aucun vi.hoisted(), aucun cast de type.
 */
...
describe("PdfController", () => {
  ...
  beforeEach(() => {
    ...
    // Injection directe — aucun vi.mock() nécessaire
   ...
   *
   * Le devis n'existe pas en base → 404, sans appeler le service PDF.
   */
  ...
  /*
   * Test 3 — Cas nominal : devis complet avec entreprise, contact et lignes
   */
